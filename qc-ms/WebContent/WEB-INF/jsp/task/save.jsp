...
<div class="block-area" id="multi-column">
    <form id="frm_task" class="row form-columned form-validation" role="form">
        ...
        <div class="col-md-6">
            <input name="title" type="text" class="form-control input-sm m-b-10" data-validation-engine="validate[required,maxSize[50]]" placeholder="标题">
        </div>
        <div class="col-md-6">
            <input name="subTitle" type="text" class="form-control input-sm m-b-10" data-validation-engine="validate[required,maxSize[50]]" placeholder="子标题">
        </div>
        
         <div class="col-md-6">
         	 <input id="task_icon" name="icon" type="text" class="form-control input-sm m-b-10" data-validation-engine="validate[required]" placeholder="图标">
         </div>
        ...
        <div class="col-md-6">
            <input name="point" type="text" class="form-control input-sm m-b-10" data-validation-engine="validate[required,min[1]]" placeholder="阅读积分（100积分=1元）" value="10">
        </div>
        <div class="col-md-6">
            <input name="limitRead" type="text" class="form-control input-sm m-b-10" data-validation-engine="validate[required,min[1]]" placeholder="阅读限制" value="5000">
        </div>
        
        <div class="col-md-6">
        	<input name="startTime" type="text" class="input-sm form-control mask-date-time" placeholder="开始时间（格式：yyyy-MM-dd HH）">
        </div>
        
        <div class="col-md-6">
           <div class="input-icon datetime-pick date-only">
               <input name="finishTime" data-format="yyyy-MM-dd" type="text" class="form-control input-sm m-b-10" data-validation-engine="validate[required]" placeholder="完成时间" value="2016-12-30"/>
               <span class="add-on">
                   <i class="sa-plus"></i>
               </span>
           </div>
...
<!--         </div> -->
        ...
        <hr class="whiter m-b-20 m-t-10">
        
        <!-- 任务内容的类型 1、url 2、文章 -->
        <div class="col-md-12">
            <select name="ctype" class="select m-b-10">
        ...
        <div id="curl" class="col-md-12">
            <input name="curl" type="text" class="form-control input-sm m-b-10" data-validation-engine="validate[required,url]" placeholder="地址信息栏">
        </div>
        
        <div id="ccontent" class="col-md-12  m-b-10">
    ...
    $("[class*='form-validation']").validationEngine({
    	onValidationComplete:function(form, valid){
    		if(valid) {
    			...
    			$.post("${path}/admin/task/save",para, function(result){
    				if(result == 'ok') {
